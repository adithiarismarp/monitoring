    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('aksi', function ($member) {
                return '
                <div class="btn-group">
                    <a type="button" onclick="editForm(`' . route('member.update', $member->id_member) . '`)"><i class="fa fa-pencil"></i></a>&nbsp&nbsp
                    <a type="button" onclick="deleteData(`' . route('member.destroy', $member->id_member) . '`)"><i class="fa fa-trash"></i></a>
                </div>
                ';
            })
